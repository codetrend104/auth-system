...
<body class="login-body">
  ...
  <div class="container mt-0">
    ...
    <form class="form-signin" id="registerform" action="./store.php" method="POST">
      <h2 class="form-signin-heading">ثبت نام کنید</h2>
      <div class="login-wrap">
        ...
        <button class="btn btn-lg btn-login btn-block" type="submit">ثبت نام</button>
        <a href="./login.php" class=" d-flex btn btn-lg btn-register btn-warning btn-block" style="color: white;">بازگشت</a>
