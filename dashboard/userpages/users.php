...
/* select data from database for using in the table and show userinfo */
                ...
                <div class="row" style="background-color: #fcfcfc;">
                    <div class="modal" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content" style="margin-right: -588px;">
                                <div class="modal-header d-flex justify-content-center">
                                    <i class="fa fa-info-circle" style="font-size:68px; color: orange;"></i>
                                </div>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary text-white  d-flex align-items-center" data-bs-dismiss="modal" style="height: 7vh;font-size: 18px;">Close</button>
                                    <a id="deletedata" onclick="call()" class="btn btn-danger text-white d-flex align-items-center" style="height: 7vh;font-size: 18px;">delete</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 col-sm-12 d-flex flex-column mt-5" style=" height: 100vh; display: flex; justify-content: start; padding: 40px; font-weight: bold;">
                        <div class="x_panel">
                            <div class="x_title">
                                <h1 style=" font-weight: bold;">لیست کاربران</h1>
                                <div class="table-response text-center mt-5 d-flex justify-content-center">
                                    <table class="table w-100 table-bordered bg-light text-secondary mb-5 fs-3" id="myTable">
                                        <thead>
                                            <th>id</th>
                                            <th>userName</th>
                                            <th>firstname</th>
                                        ...
                                        <tbody>
                                            <?php while ($result = $stmt->fetch()) { ?>
                                                <tr>
                                                    ...
                                                    <td class="w-25 ">
                                                        <a href="./edit.php?id=<?= $result["id"] ?>" class="text-secondary" style=" font-size: 20px;padding: 15px; text-decoration: none;">Edit</a>
                                                        <a class="deletbtne text-secondary" style="padding: 15px; font-size: 20px; cursor: pointer; text-decoration: none;" onclick="deletefunc(event , <?= $result["id"] ?>)"></a>
                                                        <?php if ($result["id"] != $_SESSION["id"]) { ?>
                                                            <a class="deletbtne text-secondary" style="border-left: 1px solid #dee2e6;padding: 15px; font-size: 20px; cursor: pointer; text-decoration: none;" onclick="deletefunc(event , <?= $result["id"] ?>)">delete</a>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                                <?php $_SESSION["src"] = "/dashboard/uploads/" . $result["src"] ?>
                                                <?php if (empty($result["src"])) ?>
                                                <?php $_SESSION["src"] = "/img/images.png" ?>
